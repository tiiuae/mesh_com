                                                    ...
                                                    for x_5 in gen_5:
                                                        ...
                                                        with engine.prove('ness_fact', 'is_number_nodes', context,
                                                            ...
                                                            for x_6 in gen_6:
                                                                ...
                                                                print("Inferred index = ",
                                                                      int(context.lookup_data('index')[0]))
                                                                print("Inferred nnode = ",
                                                                      int(context.lookup_data('nnode')[0]))
                                                                print("Inferred latest_status_list = ",
                                                                      context.lookup_data('latest_status_list'))
                                                                print("Inferred good_server_status_list = ",
                                                                      context.lookup_data('good_server_status_list'))
                                                                print("Inferred flags_list = ",
                                                                      context.lookup_data('flags_list'))
                                                                print("Inferred servers_list = ",
